...
class UserProxyWebAgent(UserProxyAgent):
    ...
    def __init__(self, *args, **kwargs):
        super(UserProxyWebAgent, self).__init__(
            *args,
            **kwargs,
        )
        ...
        self.register_reply(
            [Agent, None],
            UserProxyWebAgent.a_check_termination_and_human_reply,
        )
    ...
    def set_queues(self, client_sent_queue: Queue, client_receive_queue: Queue):
